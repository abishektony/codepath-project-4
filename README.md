# Web Development Project 4 - Veni Vici - Discover a Movie
Submitted by: Abishek Tony

This web app: Shows movies where you can ban certain elements to get other output 
